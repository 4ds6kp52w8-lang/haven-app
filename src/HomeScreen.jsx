...
function FeatureCard({ feature, index, onClick }) {
  ...
  <svg width="24" height="24" viewBox="0 0 446 511.568" fill="rgba(255,255,255,0.85)">
  ...
  <svg width="28" height="16" viewBox="0 0 1006.6461 574.1317" fill="rgba(255,255,255,0.85)">
